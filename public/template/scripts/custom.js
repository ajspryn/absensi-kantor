...
document.addEventListener("DOMContentLoaded", () => {
    ...
    var pwaName = "AbsensiApp"; //Local Storage Names for PWA
    ...
    function init_template() {
        ...
        // document.body.setAttribute("style", ""); // DISABLED: This causes modal interaction freeze
        ...
        window.addEventListener("scroll", function () {
            if (
                ...
                if (passed_header) {
                    ...
                    if (headerBar)
                        headerBar.classList.remove("header-bar-detached");
                    if (footerBar)
                        footerBar.classList.remove("footer-bar-detached");
                } else {
                    var headerBar = document.querySelector(".header-bar");
                    var footerBar = document.querySelector("#footer-bar");
                    if (headerBar)
                        headerBar.classList.add("header-bar-detached");
                    if (footerBar)
                        footerBar.classList.add("footer-bar-detached");
                }
            }
        });
        ...
        var toastDismiss = document.querySelectorAll(
            '[data-bs-dismiss="toast"]'
        );
        toastDismiss.forEach((el) => {
            el.addEventListener("click", (e) => {
                var notificationBar =
                    document.querySelectorAll(".notification-bar");
            ...
            if (
                ...
                document
                    ...
                    .forEach((x) =>
                        x.setAttribute(
                            "href",
                            "whatsapp://send?text=" + shareLink
                        )
                    );
                document
                    .querySelectorAll(".shareToMail")
                    .forEach((x) =>
                        x.setAttribute("href", "mailto:?body=" + shareLink)
                    );
                document
            ...
            if (navigator.canShare) {
                ...
                shareMenu.forEach((el) => {
                    el.addEventListener("click", async () => {
                        document
                            .querySelectorAll("#menu-share")[0]
                            .classList.remove("show");
                        document
                            .querySelectorAll(".offcanvas-backdrop")[0]
                            .classList.remove("show");
        ...
        function setHighlights() {
            ...
            highlightData.forEach((el) =>
                el.addEventListener("click", (e) => {
                    ...
                    el.querySelectorAll("i")[0].classList.add(
                        "bi-check-circle-fill"
                    );
                })
            );
